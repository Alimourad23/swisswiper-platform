...
export default async function AdminAccessPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-5">
      <ModuleHeader icon={adminIcon} title="Admin" subtitle="Access overview — who sees what" />
      <AdminNav active="access" />
      {view.ok ? <AccessMatrix people={view.people} teams={view.teams} /> : <SetupNote reason={view.reason} />}
    </div>
  );
}
